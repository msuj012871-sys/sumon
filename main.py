...
uid=YOUR_UID,password=YOUR_PASS
...
def load_jwt_token():
    try:
        with open("token_bd.json", "r") as f:
            data = json.load(f)
            return data["token"]   # only one token
    except:
        print("❌ No token found in token_bd.json")
        return None
...
📱 Player will see:
"—͞SUMON wants to join your team"
...
async def handle_msg_spam_completion(spam_task, message_text, times, sender_uid, chat_id, chat_type, key, iv):
    ...
    try:
        ...
        if actual_times >= times:
            completion_msg = f"[B][C][00FFFF]✅ MESSAGE SPAM COMPLETED!\n"
...
[FFDD00]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[00FF00][b][c]BOT MADE BY Ꭻuʙꫝყᴇʀ GAMER
"""
        else:
...
def get_level_info(uid):
    try:
        url = f"https://re-toxic-level-info.vercel.app/level?uid={uid}&region=bd"
        res = requests.get(url, timeout=10)
...
[FFDD00]━━━━━━━━━━━━━━━━━━━━━━
[00FF00][b][c]⚡ BOT MADE BY SUMON 9X
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
        else:
...
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY ㅤSUMON 9X
"""
        else:
...
def talk_with_ai(question):
    url = f"https://apiiiiiii.vercel.app/api/ask?prompt={question}"
    try:
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]SUMON 9X OFFICIAL [00FF00]!!
"""
...
def get_player_add(uid):
    try:
        url = f"https://xraddlist.vercel.app/adding_friend?uid=4191127326&password=350A2D71D882988454E42D8851ABDD1ACEFEBA3744174EC786440C573826A6F9&friend_uid={player_uid}"
        res = requests.get(url)
        data = res.json()
...
[1E90FF]ＤＥＶ   [FF0000]H ꫝ s ɪ ʙㅤ6 T 9 C O D E X
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FF0000]_ _ _ X ³ _ _ _ _  
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000]Ꭻuʙꫝყᴇʀ
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]sumon_9x_0
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
...
[b][c][FFFFFF]Wʟᴄ Tᴏ SUMON 9X Bᴏᴛ Hᴇʀᴇ 

❀️ [B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[00FFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]⚡Wʟᴄ Tᴏ SUMON 9X Bᴏᴛ⚡[00FFFF]║
...
"""
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """
[C][B][00BFFF]╔════════════════════╗
[FFFFFF]✨ Join Our Official Chanel YOUTUBE
[FFFFFF]⚡ [00E5FF]@sumon_9x_0 💎
[FF00FF]Thank you for your continued support
[7CFC00]╠════════════════════╣
[7FFF00]⚡ Owner : [FFFFFF]ㅤSUMON 9X
[00FFFF]✨ To purchase a GUILD BOT,
[00bFFF]please contact us on Telegram:
[FFFFFF]@sumon_9x_0 💎
[FF00FF]╚════════════════════╝
[27F5BE]✨ Developed by —͟͞͞ </> [00E5FF]—͞SUMON 9Xᅠ❄️
"""
...
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "SUMON 9X", key, iv)
                        ...
                        BLOCKED_NAMES = ["sumon 9x", "sumon", "sumon_9x", "codex"]  # Add your actual name
    ...
    "{Name} তুমি বাতরুম এর কাজ করো"
                        ...
                        if inPuTMsG.strip() == '@sevos':
                            if evo_cycle_task and not evo_cycle_task.done():
                                evo_cycle_running = False
                                evo_cycle_task.cancel()
                                success_msg = f"[B][C][00FFFF]✅ SUCCESS! Evolution emote cycle stopped successfully!\n"
                                await safe_send_message(response.Data.chat_type, success_msg, uid, chat_id, key, iv)
                                print("Evolution emote cycle stopped by command")
                            else:
                                error_msg = f"[B][C][FF00FF]❌ ERROR! No active evolution emote cycle to stop!\n"
                                await safe_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)
                        ...
                        if inPuTMsG.strip().startswith('/spm'):
                            ...
                            if len(parts) < 2:
                                ...
                                # SUCCESS MESSAGE
                                success_msg = f"[B][C][00FFFF]✅ SUCCESS! Spam request started successfully!\n"
                                await safe_send_message(response.Data.chat_type, success_msg, uid, chat_id, key, iv)
                        ...
                        if inPuTMsG.strip() == '/sspm':
                            if spam_request_task and not spam_request_task.done():
                                spam_request_running = False
                                spam_request_task.cancel()
                                success_msg = f"[B][C][FF00FF]✅ SUCCESS! Spam request stopped successfully!\n"
                                await safe_send_message(response.Data.chat_type, success_msg, uid, chat_id, key, iv)
                            else:
                            ...
                            try:
                                ...
                                for attempt in range(max_retries):
                                    ...
                                    if cache_data:
                                        ...
                                        # Build response
                                        status_msg = f"[B][C][00FFFF]📊 PLAYER STATUS MADE BY SUMON 9X\n"
                                        status_msg += f"────────────────\n"
                                ...
                                if not uids or not number:
                                    ...
                                    try:
                                        ...
                                        if number_int not in EMOTE_MAP:
                                            ...
                                            success_msg = f"[B][C][00E5FF]✅ SUCCESS! Fast evolution emote spam started!\nTargets: {len(uids)} players\nEmote: {number_int} (ID: {emote_id})\nSpam count: 25 times\nInterval: 0.1 seconds\n"
                                            await safe_send_message(response.Data.chat_type, success_msg, uid, chat_id, key, iv)
...
[FFFFFF]Example: /bundle midnight"""
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "sumon", "hi", "commands"):
                            print(f"Help command detected from UID: {uid} in chat type: {XX}")
    

    
                            basic = """[B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[00FFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]⚡ADVANCED MODE⚡[00FFFF]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝

[00FFFF]✦ [FFFFFF]Spam Invite (30x)
   [00FFFF]┗➤ [00FFFF]/spm_inv [uid]

[00FFFF]✦ [FFFFFF]Stop Spam
   [00FFFF]┗➤ [00FFFF]/stop spm_inv

[00FFFF]✦ [FFFFFF]Ghost Join
   [00FFFF]┗➤ [00FFFF]/ghost [code]

[00FFFF]✦ [FFFFFF]Lag Attack
   [00FFFF]┗➤ [00FFFF]/lag [code]

[00FFFF]✦ [FFFFFF]Stop Lag
   [00FFFF]┗➤ [00FFFF]/stop lag

[00FFFF]✦ [FFFFFF]Reject Spam
   [00FFFF]┗➤ [00FFFF]/reject [uid]"""
...
[00FFFF]✦ [FFFFFF]All Badges (V1–V5)
   [00FFFF]┗➤ [00FFFF]/spam [uid]"""
                            ...
                            evo = """[B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[00FFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]⚡GROUP COMMAND⚡[00FFFF]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝

[00FFFF]✦ [FFFFFF]3 PLAYER GROUP
   [00FFFF]┗➤ [00FFFF]/3
   

[00FFFF]✦ [FFFFFF]5 PLAYER GROUP
   [00FFFF]┗➤ [00FFFF]/5
   

[00FFFF]✦ [FFFFFF]6 PLAYER GROUP
   [00FFFF]┗➤ [00FFFF]/6
   

[00FFFF]✦ [FFFFFF]BOT JOIN TEAM
   [00FFFF]┗➤ [00FFFF]! [code]
   

[00FFFF]✦ [FFFFFF]Start Match
   [00FFFF]┗➤ [00FFFF]/start
   

[00FFFF]✦ [FFFFFF]Leave Group
   [00FFFF]┗➤ [00FFFF]/exit"""
                            await safe_send_message(response.Data.chat_type, evo, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)            
                                            

                            spam_cmnd = """[[B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[00FFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]⚡TOOLS & FUN⚡[00FFFF]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝

[00FFFF]✦ [FFFFFF]Gali Spam
   [00FFFF]┗➤ [00FFFF]/gali [name]

[00FFFF]✦ [FFFFFF]TIK TOK INFO
   [00FFFF]┗➤ [00FFFF]/tt [username]

[00FFFF]✦ [FFFFFF]PLAYER INFO
   [00FFFF]┗➤ [00FFFF]/info [uid]

[00FFFF]✦ [FFFFFF]ADD BIO
   [00FFFF]┗➤ [00FFFF]/bio [text]"""

                            await safe_send_message(response.Data.chat_type, spam_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            badge_cmnd = """[B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[00FFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]⚡EMOTE COMMAND⚡[00FFFF]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝

[00FFFF]✦ [FFFFFF]EMOTE WITHOUT CODE's
   [00FFFF]┗➤ [00FFFF]/e [name]

[00FFFF]✦ [FFFFFF]Quick emote attack
   [00FFFF]┗➤ [00FFFF]/quick [code] [emote] [uid]

[00FFFF]✦ [FFFFFF]Play emotes without emote id's
   [00FFFF]┗➤ [00FFFF]/play [uid] [1-414]

[00FFFF]✦ [FFFFFF]Evo Emote
   [00FFFF]┗➤ [00FFFF]/evo [uid] [1-414]

[00FFFF]✦ [FFFFFF]RANDOM EVO EMOTES
   [00FFFF]┗➤ [00FFFF]@evos

[00FFFF]✦ [FFFFFF]RANDOM EVO EMOTE STOP
   [00FFFF]┗➤ [00FFFF]@sevos"""

                            await safe_send_message(response.Data.chat_type, badge_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            ad_cmnd = """[B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[00FFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]⚡INFO COMMAND⚡[00FFFF]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝

[00FFFF]✦ [FFFFFF]GROUP invite
   [00FFFF]┗➤ [00FFFF]/inv [uid]

[00FFFF]✦ [FFFFFF]JOIN COUSTOME ROOM
   [00FFFF]┗➤ [00FFFF]/joinroom [id] [pass]

[00FFFF]✦ [FFFFFF]CHECK STATUS
   [00FFFF]┗➤ [00FFFF]/status [uid]

[00FFFF]✦ [FFFFFF]BAN CHECK INFO
   [00FFFF]┗➤ [00FFFF]/check [uid]

[00FFFF]✦ [FFFFFF]instagram INFO
   [00FFFF]┗➤ [00FFFF]/ig [username]"""

                            await safe_send_message(response.Data.chat_type, ad_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            info_cmnd = """[B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[00FFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]⚡FUNNY COMMAND⚡[00FFFF]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝

[00FFFF]✦ [FFFFFF]NOOB AND SHOW
   [00FFFF]┗➤ [00FFFF]noob

[00FFFF]✦ [FFFFFF]SHOW TITLES
   [00FFFF]┗➤ [00FFFF]/title

[00FFFF]✦ [FFFFFF] 100 LIKES
   [00FFFF]┗➤ [00FFFF]/like [uid]

[00FFFF]✦ [FFFFFF]SHOW STICKER
   [00FFFF]┗➤ [00FFFF]/sticker

[00FFFF]✦ [FFFFFF]SHOW MENU 
   [00FFFF]┗➤ [00FFFF]/help
   
   [00FFFF]✦ [FFFFFF]BUNDLE LIST
   [00FFFF]┗➤ [00FFFF]/bundle
   
   [00FFFF]✦ [FFFFFF]EQUIP Legendary Bundle
   [00FFFF]┗➤ [00FFFF]/bundle [name]"""
                            ...
                            about = """[B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[00FFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]⚡BOT OWNER⚡[00FFFF]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝

[00FFFF]✦ [FFFFFF]Owner Name
   [00FFFF]┗➤ [00FFAA] SUMON 9X OFFICIAL

[00FFFF]✦ [FFFFFF]Role
   [00FFFF]┗➤ [00FFAA]Developer & Controller

[00FFFF]✦ [FFFFFF]Speciality
   [00FFFF]┣➤ [00FFAA]Bot Development
   [00FFFF]┣➤ [00FFAA]Command Systems
   [00FFFF]┗➤ [00FFAA]Automation & Tools

[00FFFF]✦ [FFFFFF]Contact
   [00FFFF]┣➤ [00FFAA]TG : @sumon_9x_0
   [00FFFF]┗➤ [00FFAA]TT : @sumon_9x_official

[00FFFF]✦ [FFFFFF]Quote
   [00FFFF]┗➤ [00FFAA]“Power comes from control”"""

                            await safe_send_message(response.Data.chat_type, about, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)
                            

                            whitelist_cmnd = """[B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[00FFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]⚡EMOTE NAMES⚡[00FFFF]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝
[00FFFF]✦ [FFFFFF]1. m10_red
   [00FFFF]┗➤ [FFFFFF]2. m10_green

[00FFFF]✦ [FFFFFF]3. 100
   [00FFFF]┗➤ [FFFFFF]4. love

[00FFFF]✦ [FFFFFF]5.rose
   [00FFFF]┗➤ [FFFFFF]6. bow

[00FFFF]✦ [FFFFFF]7. soulshaking
   [00FFFF]┗➤ [FFFFFF]8. jigdance

[00FFFF]✦ [FFFFFF]9. partydance
   [00FFFF]┗➤ [FFFFFF]10. cranekick

[00FFFF]✦ [FFFFFF]11. gloriousspin
   [00FFFF]┗➤ [FFFFFF]12. shakeitup"""

                            await safe_send_message(response.Data.chat_type, whitelist_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            last ="""[B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[00FFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]⚡EMOTE NAMES⚡[00FFFF]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝

[00FFFF]✦ [FFFFFF]13. battledance
   [00FFFF]┗➤ [FFFFFF]14. wigglewalk

[00FFFF]✦ [FFFFFF]15. furiousslam
   [00FFFF]┗➤ [FFFFFF]16. moonflip

[00FFFF]✦ [FFFFFF]17. shakewithme
   [00FFFF]┗➤ [FFFFFF]18. devilsmove

[00FFFF]✦ [FFFFFF]19. jaguardance
   [00FFFF]┗➤ [FFFFFF]20. threaten

[00FFFF]✦ [FFFFFF]21. dragonfist
   [00FFFF]┗➤ [FFFFFF]22. dangerousgame

[00FFFF]✦ [FFFFFF]23. shuffling
   [00FFFF]┗➤ [FFFFFF]24. throne"""
      ...
      # ───── Commands 68-74 ─────
                            help_7 ="""[B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[00FFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]⚡Sumon_9x_official⚡[00FFFF]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝
[b]c][00FFFF]✦ [FFFFFF]কেও এই বট কিনতে চাইলে WhatsApp এ   যোগাযোগ করুন 017599 35405 
     """
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=YOUR_UID,password=YOUR_PASS")
        return None
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 —͞SUMON 9X BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 —͞SUMON 9X BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
