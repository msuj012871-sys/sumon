...
uid=4467551791,password=RIHUU_Samiul_GS8CX

# OR Format 2: Line-separated
# uid: 4467551791
# password: RIHUU_Samiul_GS8CX
...
📱 Player will see:
"—͞SUMON 9Xᅠ wants to join your team"
...
async def handle_badge_command(cmd, inPuTMsG, uid, chat_id, key, iv, region, chat_type):
    ...
    try:
        ...
        success_msg = f"[B][C][00FFFF]✅ Successfully Sent {spam_count} Join Requests!\n🎯 Target: {target_uid}\n🏷️ Badge: {badge_value}\n"
        await safe_send_message(chat_type, success_msg, uid, chat_id, key, iv)
...
[FFDD00]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[00FFFF][b][c]BOT MADE BY Ꭻuʙꫝყᴇʀ GAMER
"""
        else:
...
def get_player_ban_status(uid):
    try:
        url = f"https://9-x-ban-check.vercel.app/bancheck?uid={uid}"
        res = requests.get(url, timeout=10)
...
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FFFF][b][c]BOT MADE BY SUMON 9X
"""
        else:
...
def talk_with_ai(question):
    url = f"https://ai-kappa-wine.vercel.app/gf?prompt={question}"
    try:
...
def get_player_info(uid):
    try:
        url = f"https://ex-mu-peach.vercel.app/info?uid={uid}"
        res = requests.get(url, timeout=10)
...
def send_likes(uid):
    try:
        ...
        likes_api_response = requests.get(
             f"https://like-fawn-kappa.vercel.app/like?uid={uid}&server_name=bd",
             timeout=15
        )
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[FFFFFF]Likes Status:
[00FFFF]Likes Sent Successfully!
[FFFFFF]Player Name : [00FFFF]{player_name}  
[FFFFFF]Likes Added : [00FFFF]{likes_added}  
[FFFFFF]Likes Before : [00FFFF]{likes_before}  
[FFFFFF]Likes After : [00FFFF]{likes_after}  
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][DA70D6]❀️Dev:[FFFFFF]</> SUMONㅤ9X
"""
...
[C][B][FF00FF]━━━━━━━━━━━━
[C][B][DA70D6]❀️Dev:[FFFFFF]</> SUMON 9X
"""
...
def get_player_add(uid):
    try:
        url = f"https://9x-add-friend.vercel.app/add?uid=4470672698&password=FREEFIRE_X_GOJO_THE_FATHER_OF_DEVELOPERRR_CL8O4JJ3C&friend_uid={uid}"
        res = requests.get(url)
        data = res.json()
...
[C][B][00FFFF]Videos     : [00BFFF]{videos}
...
[C][B][FFFF00]│[FF0000]▶[00FFFF]│[00FFFF]║[FFFFFF] SUMON 9X TCP BOT[FFFF00]║
...
[b][c][00FFFF][00FFFF]Wʟᴄ Tᴏ SUMON 9X Bᴏᴛ Hᴇʀᴇ 
❀️ [B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[FFFFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]SUMON 9X BOT[00FFFF]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝
[00FFFF]━━━━━━━━━━━━[FF69B4]"""
                        # In your auto-join (Old Handler) code, find this line:
...
"""
                        ...
                        """
                                ...
                                initial_msg = f"[B][C][00FFFF]🎬 Sending arrival animation to {target_name}...\n"
                                await safe_send_message(response.Data.chat_type, initial_msg, uid, chat_id, key, iv)
                                ...
                                try:
                                    ...
                                    if entry_packet:
                                        ...
                                        success_msg = f"[B][C][00FFFF][00FFFF]✅ ARRIVAL ANIMATION SENT!\n"
...
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                # Send initial message
                                initial_msg = f"[B][C][00FFFF]🔍 Working on room spam for {target_uid}...\n"
                                await safe_send_message(response.Data.chat_type, initial_msg, uid, chat_id, key, iv)
                                ...
                                try:
                                    ...
                                    room_msg = f"[B][C][00FFFF]🎯 Detected player in room {room_id}\n"
                                    ...
                                    start_msg = f"[B][C][00FFFF]🚀 Starting spam: {spam_count} packets to room {room_id}\n"
                                    await safe_send_message(response.Data.chat_type, start_msg, uid, chat_id, key, iv)
                                    ...
                                    for i in range(spam_count):
                                        ...
                                        # Progress updates
                                        if (i + 1) % 25 == 0:
                                            progress_msg = f"[B][C][00FFFF]📦 Progress: {i+1}/{spam_count} packets sent\n"
                                            await safe_send_message(response.Data.chat_type, progress_msg, uid, chat_id, key, iv)
                                    ...
                                    success_msg = f"[B][C][00FFFF]✅ ROOM SPAM COMPLETED!\n🎯 Target: {target_uid}\n📦 Packets: {spam_count}\n🏠 Room: {room_id}\n⚡ Speed: Ultra fast\n"
                                    await safe_send_message(response.Data.chat_type, success_msg, uid, chat_id, key, iv)
                        ...
                        BLOCKED_NAMES = ["sumon 9x", "SUMON 9X", "sumon", "sumon_9x_official", "", " সুমন","mostakim", "মোস্তাকিমভাই", "রিফাতভাই", "বোতরিফাত", "rifatmostakim", " মোস্তাকিমরিফাত","রিফাতমোস্তাকিম", "মোস্তাকিমরিফাবট", "Rifa", "ffrifatyt", "rifatvai", " rifat9x","RifaTVai", "riFAT", "RIfat", "Rifat", "RIFAT", "rifat", ]  # Add your actual name
                                ...
                                if len(parts) < 2:
                                    ...
                                    if name.lower() in [n.lower() for n in BLOCKED_NAMES]:
                                        eror_msg = (
                                            ...
                                            f"[FFFFFF]ওনার এগুলার প্রতি ইন্টারেস্ট না'{name}'!\n"
                                            f"[FF0000]তাই আমার নাম দিবা না ⛔\n"
                                            f"[FFFFFF]অন্য নাম দে ভাই তোর GF এর নাম দেহ."
                                        )
                        ...
                        # Add at the top with other global variables
                        BLOCKED_NAMES = ["sumon", "sumon9x", "sumon 9x", "SUMON 9X", "SuMoN 9X", " সুমন 9X","সুমন মিয়া", "ApUrBO", "apurBo", "APurBO", "APuRbo", " সুমন","sumon_9x_official", "SUMON_9X_OFFICIAL", "apUrbo", "apuRbo", "apurBo", " apurbO","apUrBo", "riFAT", "RIfat", "Rifat", "RIFAT", "rifat", ]  # Add your actual name
                        ...
                        if inPuTMsG.strip().startswith('/sadlater '):
                            ...
                            try:
                              ...
                              #GALLI SPAM MESSAGE 
                        # Add at the top with other global variables
                        BLOCKED_NAMES = ["rifatvai", "Rifatvai", "bd71rifat9x", "crgmostakim", "", " rIFATVAI","mostakim", "মোস্তাকিমভাই", "রিফাতভাই", "বোতরিফাত", "rifatmostakim", " মোস্তাকিমরিফাত","রিফাতমোস্তাকিম", "মোস্তাকিমরিফাবট", "Rifa", "ffrifatyt", "rifatvai", " rifat9x","RifaTVai", "riFAT", "RIfat", "Rifat", "RIFAT", "rifat", ]  # Add your actual name
                            ...
                            try:
                                ...
                                if len(parts) < 2:
                                    ...
                                    if name.lower() in [n.lower() for n in BLOCKED_NAMES]:
                                        error_msg = (
                                            f"[B][C][FF0000]⚠️ WARNING!\n"
                                            f"[FFFFFF]সা🤫লা ওনার কি তরে লা🤫রা দিসে  '{name}'!\n"
                                            f"[FF0000]ওনার এর নাম লেখতা সস কে ⛔\n"
                                            f"[FFFFFF]BC অন্য নাম দেহহহ আর আমারে কি তোর মে🤫য়ে মনে হয়."
                                        )
                                        await safe_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)
                                        continue
                                    ...
                                    messages = [
                                        "{Name} খান🤫কি মা🤫গি !!",
                                        "মা🤫গির বাচ্চা, তোর মা🤫কে চু🤫দি !!",
                                        "{Name} মা🤫গির বাচ্চা, তোর মা🤫কে 5G স্পিডে চু🤫দি !!",
                                        "{Name} লোটি মা🤫গি, তোর মা🤫কে কন🤫ডম লাগিয়ে চু🤫দি !!",
                                        "{Name} বে🤫শ্শা মা🤫গি,  প্রতিদিন 300 টাকার সার্ভিস দেই !!",
                                        "{Name} মা🤫গির বাচ্চা কয়টা ভা🤫তার লাগে তোর!!",
                                        "{Name} মা🤫গি তোকে 100 বার চু🤫দি !!",
                                        "{Name} নো🤫টি তোর মুখে থু🤫থু দেয় !!",
                                        "{Name} চুত মা🤫রানি একটা ভা🤫তার দিয়ে হয়না তোর কয়টা লাগে !!",
                                        "{Name} MG একজন কে মা🤫রা দিয়ে সান্তি হয় না তোর !!",
                                        "{Name} BC তোরে তো চু🤫দিতেও ঘিন লাগে !!",
                                        "{Name} শা🤫লার বেটি তোর বা🤫প কে মা🤫রা দিস",
                                        "{Name} কয় টাকা করে সার্ভিস দেস প্রতি তা🤫লায় গিয়ে !!",
                                        "{Name} তোর পুরা ১৪ গু🤫স্টি কে চু🤫দি",
                                        "{Name} 12 ভা🤫তারি !!",
                                        "{Name} তোর জন্য একটা লাইন বলি শোন\n                         যেখানে / সেখানে ফোন চার্জ দিবি আর ব্যাটারি ফুলে গেলে দোষ\n হায়রে মা🤫গি যা করলি জীবনে উপরে গেলে দিবনে⚠️⚠️!!",
                                            ]
...
#LOVE NAME MESSAGE 
                        # Add at the top with other global variables
                        BLOCKED_NAMES = ["sumon_9x_official", "SUMON 9X", "sumon", "সুমন"]  # Add your actual name
                            ...
                            try:
                                ...
                                if len(parts) < 2:
                                    ...
                                    messages = [
                                        ...
                                        "B][C][FFFFFF]♡ [00FFFF]লবিতে [FFFFFF]শুধু [FFD700]{Name} তোকেই খুঁজি [FFFFFF]♡",
                                        "[B][C][FFFFFF]♡ [00FFFF]এয়ারড্রপের [FFFFFF]চেয়েও [FF1493]{Name} তুই দামি [FFFFFF]♡",
                                        "[B][C][FFFFFF]♡ [FFD700]{Name} তোর হাসিতে [FFFFFF]আমার [00FFFF]HP বাড়ে [FFFFFF]♡",
...
# GLOBAL BLOCKED NAMES
                        BLOCKED_NAMES = ["সুমন", "sumon", "SUMON 9X", "SUMON9X", "sumon9x", "sumon_9x_official"]  # Protected names
                                ...
                                if not uids or not number:
                                    ...
                                    try:
                                        ...
                                        if number_int not in ALL_EMOTE:
                                            ...
                                            if success:
                                                success_msg = f"[B][C][00FFFF]✅ SUCCESS! {result_msg}\n"
                                                await safe_send_message(response.Data.chat_type, success_msg, uid, chat_id, key, iv)
                                            else:
                        ...
                        if inPuTMsG.strip().startswith('/bundle'):
                            ...
                            if len(parts) < 2:
                                ...
                                bundle_list = """[B][C][00FFFF]🎁 AVAILABLE BUNDLES 🎁
...
[FFFFFF]Example: /bundle midnight"""
                                ...
                                initial_msg = f"[B][C][00FFFF]🎁 Sending {bundle_name}\n"
                                await safe_send_message(response.Data.chat_type, initial_msg, uid, chat_id, key, iv)
                                ...
                                try:
                                    ...
                                    if bundle_packet and online_writer:
                                        ...
                                        success_msg = f"[B][C][00FFFF]✅ Done: {bundle_name}"
                                        await safe_send_message(response.Data.chat_type, success_msg, uid, chat_id, key, iv)
                                    else:
                        ...
                        if inPuTMsG.strip().lower() in ("5", "/help", "hi", "hello", "5"):
                            ...
                            header = """[B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][FFFF00]│[FF0000]▶[00FFFF]│[00FFFF]║[FFFFFF] SUMON 9Xㅤ TCP BOT[FFFF00]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝"""
                            ...
                            p1 = """[C][B][FF00FF]━━━━━━━━━━━━━━
[FFFFFF]      SUMON 9X TCP MENU 01
[FF00FF]━━━━━━━━━━━━━━
[00FF00]01│ 3 Player Group
[FF0000]└─ /3

[00FF00]02│ 5 Player Group
[FF0000]└─ /5

[00FF00]03│ 6 Player Group
[FF0000]└─ /6

[00FF00]04│ Invite Player
[FF0000]└─ /inv [uid]
...
"""
                            ...
                            p2 = """[C][B][FF00FF]━━━━━━━━━━━━━━
[FFFFFF]      SUMON 9X TCP MENU 02
[FF00FF]━━━━━━━━━━━━━━
[00FF00]06│ Left Team
[FF0000]└─ /exit

[00FF00]07│ Start Match
[FF0000]└─ /start

[00FF00]08│ Kick Player
[FF0000]└─ /kick [uid]

[00FF00]09│ Sad Later
[FF0000]└─ /sadlater [name]

[00FF00]10│ Later Action
[FF0000]└─ /later [name]
[FF00FF]━━━━━━━━━━━━━━
"""
                            ...
                            p3 = """[C][B][FF00FF]━━━━━━━━━━━━━━
[FFFFFF]      SUMON 9X TCP MENU 03
[FF00FF]━━━━━━━━━━━━━━
[00FF00]11│ Love Meter
[FF0000]└─ /love [name]

[00FF00]12│ Praise Someone
[FF0000]└─ /praisa [name]

[00FF00]13│ Check Luck
[FF0000]└─ /luck

[00FF00]14│ Send Sticker
[FF0000]└─ /sticker

[00FF00]15│ Noob Reaction
[FF0000]└─ noob
[FF00FF]━━━━━━━━━━━━━━
"""
...
[00FF00]18│ Special Text
[FF0000]└─ /mg [text]

[00FF00]19│ DM Player
[FF0000]└─ /dm [uid] [text]

[00FF00]20│ Send Message
[FF0000]└─ /msg [text]
[FF00FF]━━━━━━━━━━━━━━
"""
                            ...
                            p5 = """[C][B][FF00FF]━━━━━━━━━━━━━━
[FFFFFF]      SUMON 9X TCP MENU 05
[FF00FF]━━━━━━━━━━━━━━
[00FF00]21│ Evo Upgrade
[FF0000]└─ /evo [uid] [1-2]
...
[00FF00]23│ Evo Cycle
[FF0000]└─ /evo_c [uids] [num] [time]

[00FF00]24│ Auto Cycle
[FF0000]└─ @ [uid]

[00FF00]25│ Stop Cycle
[FF0000]└─ @s
[FF00FF]━━━━━━━━━━━━━━
"""
                            ...
                            p6 = """[C][B][FF00FF]━━━━━━━━━━━━━━
[FFFFFF]      SUMON 9X TCP MENU 06
[FF00FF]━━━━━━━━━━━━━━
[00FF00]26│ Title System
[FF0000]└─ /title

[00FF00]27│ Bundle Menu
[FF0000]└─ /bundle

[00FF00]28│ Select Bundle
[FF0000]└─ /bundle [name]

[00FF00]29│ Quick Inv
[FF0000]└─ /inv [uid]

[00FF00]30│ Start System
[FF0000]└─ /start
[FF00FF]━━━━━━━━━━━━━━
"""
...
"""
                            ...
                            p8 =  """[C][B][FF00FF]━━━━━━━━━━━━━━
[FFFFFF]      SUMON 9X TCP MENU 08
[FF00FF]━━━━━━━━━━━━━━
[00FF00]36│ Spam Badges
[FF0000]└─ /spam [uid]

[00FF00]37│ Player Info
[FF0000]└─ /info [uid]
...
"""
                            ...
                            p9 = """[C][B][FF00FF]━━━━━━━━━━━━━━
[FFFFFF]      SUMON 9X TCP MENU 09
[FF00FF]━━━━━━━━━━━━━━
[00FF00]41│ Level Check
[FF0000]└─ /lv [uid]

[00FF00]42│ Ban Check
[FF0000]└─ /check [uid]

[00FF00]43│ Ghost Attack
[FF0000]└─ /ghost [code]

[00FF00]44│ Multi Join
[FF0000]└─ /multijoin [uid]
...
"""
                            ...
                            p10 = """[C][B][FF00FF]━━━━━━━━━━━━━━
[FFFFFF]      SUMON 9X TCP MENU 10
[FF00FF]━━━━━━━━━━━━━━
[00FF00]46│ Spam Invite
[FF0000]└─ /spm [uid] [count]

[00FF00]47│ Lag Player
[FF0000]└─ /lag [uid]

[00FF00]48│ Invite Loop
[FF0000]└─ /inv [uid]

[00FF00]49│ Freeze Player
[FF0000]└─ /freeze [uid]

[00FF00]50│ Emote Attack
[FF0000]└─ /e [tmcd] [emote_id]
[FF00FF]━━━━━━━━━━━━━━
"""
                            ...
                            p11 ="""[C][B][FF00FF]━━━━━━━━━━━━━━
[FFFFFF]      SUMON 9X TCP MENU 11
[FF00FF]━━━━━━━━━━━━━━
[00FF00]51│ Update Bio
[FF0000]└─ /bio [text]

[00FF00]52│ Love Percent
[FF0000]└─ /love [name]
...
"""
                            ...
                            p12 =  """[C][B][FF00FF]━━━━━━━━━━━━━━
[FFFFFF]      SUMON 9X TCP MENU 12
[FF00FF]━━━━━━━━━━━━━━
[00FF00]56│ Stop Lag
[FF0000]└─ /stop_lag

[00FF00]57│ Add Friend
[FF0000]└─ /add [uid]

[00FF00]58│ Admin Info
[FF0000]└─ /admin [contact]
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=4467551791,password=RIHUU_Samiul_GS8CX")
        return None
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 —͞SUMON 9Xᅠ BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 —͞SUMON 9Xᅠ BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
